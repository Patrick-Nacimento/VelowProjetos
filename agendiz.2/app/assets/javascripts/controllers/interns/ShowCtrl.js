this.app.controller('InternsShowCtrl', ['$scope', 'Dialog', '$rootScope', '$filter', '$window', '$controller', 'Dialog', '$timeout', '$location', function ($scope, Dialog, $rootScope, $filter, $window, $controller, Dialog, $timeout, $location) {
